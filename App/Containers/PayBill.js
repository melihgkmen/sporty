          ...
          <SafeAreaView
            ...
            <ScrollView>
              <View style={{marginTop:10}}>
                <TouchableOpacity
                  onPress={() =>  NavigationService.navigate('PayBillDetail')}>
                  <View style={styles.buttonStyle}>
                    <LinearGradient
                      ...
                      <View style={{width: '65%', flexDirection: 'row'}}>
                        <Image
                          source={require('../Assets/Images/fatura-ode.png')}
                ...
                <TouchableOpacity
                  ...
                  <View style={styles.buttonStyle}>
                    <LinearGradient
                      ...
                      <View style={{width: '65%', flexDirection: 'row'}}>
                        <Image
                          source={require('../Assets/Images/kayıtlı-fatura.png')}
                          style={styles.maskFourImage}
                        />
                        <Text style={styles.elektrikFaturasıText}>
                ...
                <TouchableOpacity
                  ...
                  <View style={styles.buttonStyle}>
                    <LinearGradient
                      ...
                      <View style={{width: '65%', flexDirection: 'row'}}>
                        <Image
                          source={require('../Assets/Images/add-bill.png')}
                          style={styles.maskFourImage}
                        />
                        <Text style={styles.elektrikFaturasıText}>
                          Yeni Fatura İşlemleri
                        </Text>
                      </View>
                      <View style={{width: '35%', alignItems: 'flex-end'}}>
                        <Icon
